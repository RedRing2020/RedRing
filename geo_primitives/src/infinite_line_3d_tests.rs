...
mod tests {
    ...
    fn test_infinite_line3d_creation() {
        ...
        assert_eq!(line.direction(), Vector3D::unit_x());
    }
    ...
    fn test_infinite_line3d_axis_constructors() {
        ...
        let x_line = InfiniteLine3D::x_axis_line(point);
        let y_line = InfiniteLine3D::y_axis_line(point);
        let z_line = InfiniteLine3D::z_axis_line(point);

        assert_eq!(x_line.direction(), Vector3D::unit_x());
        assert_eq!(y_line.direction(), Vector3D::unit_y());
        assert_eq!(z_line.direction(), Vector3D::unit_z());
    }
    ...
    fn test_infinite_line3d_point_projection() {
        let line = InfiniteLine3D::x_axis_line(Point3D::origin());
    ...
    fn test_infinite_line3d_distance_to_point() {
        let line = InfiniteLine3D::x_axis_line(Point3D::<f64>::origin());
    ...
    fn test_infinite_line3d_parallel_lines() {
        let line1 = InfiniteLine3D::x_axis_line(Point3D::<f64>::origin());
        let line2 = InfiniteLine3D::x_axis_line(Point3D::new(0.0, 1.0, 0.0));
        let line3 = InfiniteLine3D::y_axis_line(Point3D::origin());
    ...
    fn test_infinite_line3d_coincident_lines() {
        let line1 = InfiniteLine3D::x_axis_line(Point3D::<f64>::origin());
        let line2 = InfiniteLine3D::x_axis_line(Point3D::new(5.0, 0.0, 0.0));
        let line3 = InfiniteLine3D::x_axis_line(Point3D::new(0.0, 1.0, 0.0));
    ...
    fn test_infinite_line3d_closest_points() {
        let line1 = InfiniteLine3D::x_axis_line(Point3D::<f64>::origin());
        let line2 = InfiniteLine3D::y_axis_line(Point3D::origin());
    ...
    fn test_infinite_line3d_axis_alignment() {
        let x_line = InfiniteLine3D::x_axis_line(Point3D::origin());
        let diagonal_line =
    ...
    fn test_basic_directional() {
        ...
        assert_eq!(reversed.direction(), Vector3D::unit_x().negate());
    }
    ...
    fn test_infinite_line3d_f32_compatibility() {
        ...
        assert_eq!(line_f32.direction(), Vector3D::unit_x());
        assert_eq!(line_f64.direction(), Vector3D::unit_x());
    }
}
