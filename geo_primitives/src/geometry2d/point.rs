...
use geo_core::{Point2D as CorePoint2D, Scalar};
...
impl Point2D {
    ...
    pub fn new(x: f64, y: f64) -> Self {
        Self {
            inner: CorePoint2D::from_f64(x, y),
        }
    }
    ...
    pub fn to_vector(&self) -> geo_core::Vector2D {
        geo_core::Vector2D::new(Scalar::new(self.x()), Scalar::new(self.y()))
    }

    /// 他の点に向かうベクトルを計算
    pub fn vector_to(&self, other: &Point2D) -> geo_core::Vector2D {
        geo_core::Vector2D::new(
