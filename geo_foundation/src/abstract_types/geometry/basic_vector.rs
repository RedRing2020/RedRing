...
use crate::Scalar;
use super::foundation::{GeometryFoundation, BasicMetrics};
...
impl std::fmt::Display for VectorNormalizationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            VectorNormalizationError::ZeroLength => write!(f, "Cannot normalize zero-length vector"),
            VectorNormalizationError::NumericalInstability => write!(f, "Numerical instability in vector normalization"),
        }
    }
}
