...
impl<T: Scalar> Matrix4x4<T> {
    ...
    pub fn rotation_x(angle: T) -> Self {
        ...
        Self::new(
            T::ONE, T::ZERO, T::ZERO, T::ZERO,
            T::ZERO, cos_a, -sin_a, T::ZERO,
            T::ZERO, sin_a, cos_a, T::ZERO,
            T::ZERO, T::ZERO, T::ZERO, T::ONE
        )
    }
    ...
    pub fn rotation_y(angle: T) -> Self {
        ...
        let sin_a = angle.sin();
        Self::new(
            cos_a, T::ZERO, sin_a, T::ZERO,
            T::ZERO, T::ONE, T::ZERO, T::ZERO,
            -sin_a, T::ZERO, cos_a, T::ZERO,
            T::ZERO, T::ZERO, T::ZERO, T::ONE
        )
    }
    ...
    pub fn rotation_z(angle: T) -> Self {
        ...
        let sin_a = angle.sin();
        Self::new(
            cos_a, -sin_a, T::ZERO, T::ZERO,
            sin_a, cos_a, T::ZERO, T::ZERO,
            T::ZERO, T::ZERO, T::ONE, T::ZERO,
            T::ZERO, T::ZERO, T::ZERO, T::ONE
        )
    }
    ...
    pub fn perspective(fovy: T, aspect: T, near: T, far: T) -> Self {
        ...
        Self::new(
            ...
            T::ZERO, T::ZERO, (near + far) * range_inv, (T::ONE + T::ONE) * near * far * range_inv,
            T::ZERO, T::ZERO, -T::ONE, T::ZERO
        )
    }
    ...
    pub fn perspective_rh_01(fovy: T, aspect: T, near: T, far: T) -> Self {
        ...
        Self::new(
            f / aspect, T::ZERO, T::ZERO, T::ZERO,
            T::ZERO, f, T::ZERO, T::ZERO,
            T::ZERO, T::ZERO, far * range_inv, near * far * range_inv,
            T::ZERO, T::ZERO, -T::ONE, T::ZERO
        )
    }
    ...
    pub fn orthographic(left: T, right: T, bottom: T, top: T, near: T, far: T) -> Self {
        ...
        Self::new(
            ...
            T::ZERO, T::ZERO, -two * fn_inv, -(far + near) * fn_inv,
            T::ZERO, T::ZERO, T::ZERO, T::ONE
        )
    }
