...
impl Constants for f32 {
    ...
    fn e() -> Self { std::f32::consts::E }
    fn pi_2() -> Self { Self::pi() / 2.0 }
    fn pi_4() -> Self { Self::pi() / 4.0 }
    fn deg_to_rad() -> Self { Self::pi() / 180.0 }
    fn rad_to_deg() -> Self { 180.0 / Self::pi() }
    fn geometric_tolerance() -> Self { 1e-6 }
}

impl Constants for f64 {
    fn pi() -> Self { std::f64::consts::PI }
    fn tau() -> Self { std::f64::consts::TAU }
    fn e() -> Self { std::f64::consts::E }
    fn pi_2() -> Self { Self::pi() / 2.0 }
    fn pi_4() -> Self { Self::pi() / 4.0 }
    fn deg_to_rad() -> Self { Self::pi() / 180.0 }
    fn rad_to_deg() -> Self { 180.0 / Self::pi() }
    fn geometric_tolerance() -> Self { 1e-10 }
}
...
pub mod recommended {
    ...
    impl MathConstants for f32 {
        fn pi() -> Self { game::PI }
        fn tau() -> Self { game::TAU }
        fn tolerance() -> Self { game::TOLERANCE }
    }
    
    impl MathConstants for f64 {
        fn pi() -> Self { precision::PI }
        fn tau() -> Self { precision::TAU }
        fn tolerance() -> Self { precision::TOLERANCE }
    }
}
