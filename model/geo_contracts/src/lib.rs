...
pub use geometry::core::{
    ...
    EllipseArc3DProperties, EllipsoidalSolid3DConstructor, EllipsoidalSolid3DCore,
    EllipsoidalSolid3DMeasure, EllipsoidalSolid3DProperties, EllipsoidalSurface3DConstructor,
    ...
    TorusSolid3DProperties, TorusSurface3DConstructor, TorusSurface3DCore, TorusSurface3DDerived,
    TorusSurface3DDistance, TorusSurface3DEvaluation, TorusSurface3DProperties,
