//! CylindricalSurface3D - Intersection Implementation
//!
//! 3次元円柱サーフェスの交差判定実装
//!
...
impl<T: Scalar> BasicIntersection<T, Point3D<T>> for CylindricalSurface3D<T> {
...
impl<T: Scalar> BasicIntersection<T, Circle3D<T>> for CylindricalSurface3D<T> {
    type Point = Point3D<T>;
...
impl<T: Scalar> BasicIntersection<T, LineSegment3D<T>> for CylindricalSurface3D<T> {
    type Point = Point3D<T>;
...
impl<T: Scalar> BasicIntersection<T, Triangle3D<T>> for CylindricalSurface3D<T> {
    type Point = Point3D<T>;
...
impl<T: Scalar> BasicIntersection<T, Plane3D<T>> for CylindricalSurface3D<T> {
    type Point = Point3D<T>;
...
impl<T: Scalar> MultipleIntersection<T, Point3D<T>> for CylindricalSurface3D<T> {
    type Point = Point3D<T>;
...
impl<T: Scalar> MultipleIntersection<T, Circle3D<T>> for CylindricalSurface3D<T> {
    type Point = Point3D<T>;
...
impl<T: Scalar> MultipleIntersection<T, LineSegment3D<T>> for CylindricalSurface3D<T> {
    type Point = Point3D<T>;
...
impl<T: Scalar> MultipleIntersection<T, Triangle3D<T>> for CylindricalSurface3D<T> {
    type Point = Point3D<T>;
...
impl<T: Scalar> MultipleIntersection<T, Plane3D<T>> for CylindricalSurface3D<T> {
    type Point = Point3D<T>;
...
impl<T: Scalar> MultipleIntersection<T, CylindricalSurface3D<T>> for CylindricalSurface3D<T> {
    type Point = Point3D<T>;
...
impl<T: Scalar> SelfIntersection<T> for CylindricalSurface3D<T> {
    type Point = Point3D<T>;
