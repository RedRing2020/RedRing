...
// ============================================================================
// Builder テスト (bbox_2d_builder_tests.rs から統合)
// ============================================================================
...
fn test_bbox2d_builder_with_intersection() {
    ...
    let points1 = vec![Point2D::new(0.0, 0.0), Point2D::new(2.0, 2.0)];
    let bbox1 = BBox2D::from_point_collection(&points1).unwrap();

    let points2 = vec![Point2D::new(1.0, 1.0), Point2D::new(3.0, 3.0)];
...
fn test_bbox2d_builder_chaining() {
    ...
    let additional_points = vec![Point2D::new(3.0, 0.0), Point2D::new(0.0, 3.0)];
