...
// 3D プリミティブ
pub mod arc_3d;
pub mod arc_3d_analysis_transform; // Arc3D のAnalysis Transform実装
...
pub mod bbox_3d_analysis_transform; // BBox3D の Analysis Matrix4x4 統合変換
...
pub mod conical_solid_3d_analysis_transform; // ConicalSolid3D の Analysis Transform 実装
...
pub mod conical_surface_3d_analysis_transform; // ConicalSurface3D の Analysis Matrix4x4 統合変換
...
pub mod cylindrical_solid_3d_analysis_transform; // CylindricalSolid3D の Analysis Matrix4x4 統合変換
...
pub mod cylindrical_surface_3d_analysis_transform; // CylindricalSurface3D の Analysis Matrix4x4 統合変換
...
pub mod direction_3d_analysis_transform; // Direction3D Analysis Matrix変換実装
...
pub mod ellipsoidal_surface_3d_analysis_transform; // EllipsoidalSurface3D の Analysis Matrix4x4 統合変換
...
pub mod spherical_solid_3d_analysis_transform; // SphericalSolid3D の解析変換機能 (Analysis Transform)
...
pub mod spherical_surface_3d_analysis_transform; // SphericalSurface3D の解析変換機能 (Analysis Transform)
...
pub mod torus_solid_3d_analysis_transform; // TorusSolid3D の解析変換機能 (Analysis Transform)
...
pub mod torus_surface_3d_analysis_transform; // TorusSurface3D の解析変換機能 (Analysis Transform)
...
pub mod arc_2d_analysis_transform; // Arc2D の Analysis Matrix3x3 統合変換
...
pub mod bbox_2d_analysis_transform; // BBox2D の Analysis Matrix3x3 統合変換
...
pub mod direction_2d_analysis_transform; // Direction2D Analysis Matrix変換実装
