...
fn known_entrypoints() -> HashSet<String> {
    let sources = [
        ...
        include_str!("../src/intersection/primitive_3d/circular_family.rs"),
        include_str!("../src/intersection/primitive_3d/cylindrical_and_conical_family.rs"),
        include_str!("../src/intersection/primitive_3d/linear_family.rs"),
        include_str!("../src/intersection/primitive_3d/planar_and_mesh_family.rs"),
        include_str!("../src/intersection/primitive_3d/spherical_and_quadric_family.rs"),
...
#[path = "coverage_matrix_engine/entries_2d_collision.rs"]
mod entries_2d_collision;
#[path = "coverage_matrix_engine/entries_2d_distance.rs"]
mod entries_2d_distance;
#[path = "coverage_matrix_engine/entries_2d_intersection.rs"]
mod entries_2d_intersection;
#[path = "coverage_matrix_engine/entries_3d_collision.rs"]
mod entries_3d_collision;
#[path = "coverage_matrix_engine/entries_3d_distance.rs"]
mod entries_3d_distance;
#[path = "coverage_matrix_engine/entries_3d_intersection.rs"]
mod entries_3d_intersection;

fn valid_seed_entries() -> Vec<MatrixEntry> {
    let mut entries = Vec::new();
    entries.extend(entries_2d_collision::entries());
    entries.extend(entries_2d_intersection::entries());
    entries.extend(entries_2d_distance::entries());
    entries.extend(entries_3d_collision::entries());
    entries.extend(entries_3d_intersection::entries());
    entries.extend(entries_3d_distance::entries());
    entries
}
#[test]
