...
use crate::Point3D;
use geo_foundation::{
    core::{vector_traits, vector_traits::VectorOps as VectorOpsTrait},
    ExtensionFoundation, PrimitiveKind, Scalar, TolerantEq,
};
...
impl<T: Scalar> VectorOpsTrait<T> for Vector3D<T> {
